...
const endpoints = {
  ...
  facebookLogin:
    ...
    '&redirect_uri=' +
    facebookRedirectUrl +
    '&response_type=token&scope=email&state=' +
    redirectUrl,
  googleLogin:
    ...
    '&redirect_uri=' +
    googleRedirectUrl +
    '&scope=openid%20profile%20email&response_type=id_token&nonce=user_id&state=' +
    redirectUrl,
  githubLogin:
  ...
  linkedinLogin:
    ...
    '&redirect_uri=' +
    linkedinRedirectUrl +
    '&scope=r_emailaddress%20r_basicprofile&state=' +
    redirectUrl,
};
