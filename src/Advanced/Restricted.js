        ...
        <div className={'landingPageInnerWidth'}>
          <div className={'landingPageInnerWrapper ' + pageInnerThemeClass}>
            <div className="signUpWrapper">
              <div className={headerDescriptionClass}>Restricted</div>
              <div className="descriptionText">
                Hello! You are logged in with a role which does not allow you to
                access the service.
              </div>
              <div className="descriptionText">
              ...
              >
                <div className="signInbtn">
                  <a>
                    <button type="submit">Logout & Login Again</button>
                  </a>
                </div>
              </form>
            </div>
